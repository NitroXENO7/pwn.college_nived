...
# My solve
Ran the bash script with the static as an argument got the strings in the file and found the flag. or could've run strings on the static to get the flag.

`flag: picoCTF{d15a5m_t34s3r_98d35619}`

```bash
 Tue 30 Sep - 23:53  ~/Downloads 
 @kali  chmod +x ltdis.sh 

 Tue 30 Sep - 23:53  ~/Downloads 
 @kali  ./ltdis.sh static 
...
Any strings found in static have been written to static.ltdis.strings.txt with file offset
 ...
 Tue 30 Sep - 23:53  ~/Downloads 
 @kali  cat static.ltdis.strings.txt 
